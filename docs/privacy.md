...
Structured interview-note fixture metadata lives in `examples/interview-notes/interview-notes.jsonl`. It can list fixture file paths, expected question keywords, and `sourceUrls: []`, but it must not include real transcripts, recruiter names, phone numbers, emails, or private identifiers.
