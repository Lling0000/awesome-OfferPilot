    ...
    "examples/reports/report-fixtures.jsonl": [
        ContentRequirement(
            ...
            (
                ...
                '"report_fixture": "examples/reports/job-report-with-sourceUrls.json"',
                '"report_fixture": "examples/reports/daily-intelligence-with-sourceUrls.json"',
                '"requires_top_level_sourceUrls": true',
                '"retained_sourceUrls"',
                '"required_claim_sourceIds"',
                '"required_claim_sourceId_groups"',
                '"expected_evidence"',
